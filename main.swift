...
struct SettingsView:View {
    ...
    var body:some View {
        ScrollView {VStack(alignment:.leading,spacing:20){
            ...
            HStack{Text("拖动黑洞移动 · 双击或右键打开设置").font(.system(size:11)).foregroundStyle(.secondary);Spacer();Text("v1.2.1").font(.system(size:10,design:.monospaced)).foregroundStyle(.secondary)}
...
final class AppDelegate:NSObject,NSApplicationDelegate,NSWindowDelegate {
    ...
    @objc func about(){NSApp.orderFrontStandardAboutPanel(options:[.applicationName:"奇点 · Singularity",.applicationVersion:Bundle.main.object(forInfoDictionaryKey:"CFBundleShortVersionString") as? String ?? "1.2.1",.credits:NSAttributedString(string:"引力透镜着色器基于 s0xDk/ghostty-blackhole（MIT）。")])}
